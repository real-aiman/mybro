...
function makeBalloons(): BalloonData[] {
  ...
  return Array.from({ length: 17 }, (_, i) => {
    ...
    return {
      ...
      left: 8 + col * 21 + jitterX,
      top: 12 + row * 24 + jitterY,
      size: 78 + ((i * 37) % 40),
      delay: (i % 7) * 0.18,
...
const URDU_LETTER_LINES = [
  ...
  '',
  '17ویں سالگرہ بہت بہت مبارک ہو رُبائیشہ! 🎂💗',
  '',
...
export default function App() {
  ...
  const balloons = useMemo(() => makeBalloons(), []);
      ...
      {phase === 'main' && (
        <>
          ...
          >
            ...
            <div className="relative z-10 max-w-xl w-full text-center">
             <SectionHeading
  title={<span className="font-urdu">ایک خط رُبائیشہ کے نام 💌</span>}
              ...
              <AnimatePresence mode="wait">
                {!letterOpened ? (
                  ...
                  >
                   ...
                   <p className="mt-4 font-urdu text-xl text-champagne">رُبائیشہ کے نام ♡</p> 
